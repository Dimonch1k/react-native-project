import AppleIcon from '@/assets/images/apple-icon-light.png'
import FacebookIcon from '@/assets/images/facebook-icon-light.png'
import GmailIcon from '@/assets/images/gmail-icon-light.png'
